...
import 'package:dio_hub/common/search_overlay/search_overlay.dart' as _i5;
import 'package:dio_hub/controller/deep_linking_handler.dart' as _i18;
import 'package:dio_hub/graphql/graphql.dart' as _i19;
import 'package:dio_hub/routes/router.dart' as _i17;
import 'package:dio_hub/view/authentication/auth_screen.dart' as _i1;
import 'package:dio_hub/view/issues_pulls/issue_pull_screen.dart' as _i6;
import 'package:dio_hub/view/issues_pulls/widgets/p_r_review_screen.dart'
    as _i14;
import 'package:dio_hub/view/landing/landing.dart' as _i3;
import 'package:dio_hub/view/landing/widgets/landing_loading_screen.dart'
    as _i2;
import 'package:dio_hub/view/landing/widgets/place_holder_screen.dart' as _i4;
import 'package:dio_hub/view/profile/other_user_profile_screen.dart' as _i12;
import 'package:dio_hub/view/repository/code/file_viewer.dart' as _i8;
import 'package:dio_hub/view/repository/commits/commit_info_screen.dart' as _i9;
import 'package:dio_hub/view/repository/commits/widgets/changes_viewer.dart'
    as _i11;
import 'package:dio_hub/view/repository/issues/new_issue_screen.dart' as _i13;
import 'package:dio_hub/view/repository/repository_screen.dart' as _i7;
import 'package:dio_hub/view/repository/wiki/wiki_viewer.dart' as _i10;
...
class AppRouter extends _i15.RootStackRouter {
  ...
  final Map<String, _i15.PageFactory> pagesMap = {
    ...
    LandingLoadingScreenRoute.name: (routeData) {
      ...
      return _i15.AdaptivePage<dynamic>(
        routeData: routeData,
        child: _i2.LandingLoadingScreen(
          key: args.key,
    ...
    OtherUserProfileScreenRoute.name: (routeData) {
      ...
      return _i15.AdaptivePage<dynamic>(
        routeData: routeData,
        child: _i12.OtherUserProfileScreen(
          args.login,
          key: args.key,
        ),
      );
  ...
  List<_i15.RouteConfig> get routes => [
        ...
        _i15.RouteConfig(
          LandingLoadingScreenRoute.name,
          path: '/',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
        ...
        _i15.RouteConfig(
          PlaceHolderScreenRoute.name,
          path: '/place-holder-screen',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          SearchOverlayScreenRoute.name,
          path: '/search-overlay-screen',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          IssuePullScreenRoute.name,
          path: '/issue-pull-screen',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          RepositoryScreenRoute.name,
          path: '/repository-screen',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          FileViewerAPIRoute.name,
          path: '/file-viewer-ap-i',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          CommitInfoScreenRoute.name,
          path: '/commit-info-screen',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          WikiViewerRoute.name,
          path: '/wiki-viewer',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          ChangesViewerRoute.name,
          path: '/changes-viewer',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
        ...
        _i15.RouteConfig(
          NewIssueScreenRoute.name,
          path: '/new-issue-screen',
          guards: [authGuard],
        ),
        _i15.RouteConfig(
          PRReviewScreenRoute.name,
...
class LandingLoadingScreenRoute
  ...
  LandingLoadingScreenRoute({
    _i16.Key? key,
    String? initLink,
  }) : super(
          LandingLoadingScreenRoute.name,
          path: '/',
          args: LandingLoadingScreenRouteArgs(
            key: key,
            initLink: initLink,
          ),
        );
...
class LandingLoadingScreenRouteArgs {
  const LandingLoadingScreenRouteArgs({
    this.key,
    this.initLink,
  });
...
class CommitInfoScreenRoute
  ...
  CommitInfoScreenRoute({
    _i16.Key? key,
    required String commitURL,
  }) : super(
          CommitInfoScreenRoute.name,
          path: '/commit-info-screen',
          args: CommitInfoScreenRouteArgs(
            key: key,
            commitURL: commitURL,
          ),
        );
...
class CommitInfoScreenRouteArgs {
  const CommitInfoScreenRouteArgs({
    this.key,
...
class OtherUserProfileScreenRoute
  ...
  OtherUserProfileScreenRoute({
    ...
    _i16.Key? key,
          ...
          OtherUserProfileScreenRoute.name,
          path: '/other-user-profile-screen',
          args: OtherUserProfileScreenRouteArgs(
            login: login,
            key: key,
          ),
        );
...
class OtherUserProfileScreenRouteArgs {
  const OtherUserProfileScreenRouteArgs({
    required this.login,
    this.key,
  });
