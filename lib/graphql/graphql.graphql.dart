...
class AddReactionArguments extends JsonSerializable with EquatableMixin {
  AddReactionArguments({required this.id, required this.content});
  ...
  OperationDefinitionNode(
      ...
      variableDefinitions: [
        ...
        VariableDefinitionNode(
            ...
            type: NamedTypeNode(
                name: NameNode(value: 'ReactionContent'), isNonNull: true),
            defaultValue: DefaultValueNode(value: null),
            directives: [])
      ],
      directives: [],
...
class RemoveReactionArguments extends JsonSerializable with EquatableMixin {
  RemoveReactionArguments({required this.id, required this.content});
